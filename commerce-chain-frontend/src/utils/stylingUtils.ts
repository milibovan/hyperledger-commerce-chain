...
export const addButtonStyleSm = "p-2 bg-green-600 hover:bg-green-500 rounded border-2 border-green-400 transition-all"
...
export const traderDialogClassName = "backdrop:bg-black/80 bg-gray-800 border-2 border-pink-500 rounded-lg p-8 shadow-2xl shadow-pink-500/50 max-w-2xl w-full"
