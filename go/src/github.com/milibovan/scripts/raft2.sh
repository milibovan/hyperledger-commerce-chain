...
ORDERER_ADMIN_PORT=7058

# Set TLS and Admin credentials for the raft2 Orderer
export ORDERER_ADMIN_TLS_ROOTCERT_FILE=${TEST_NETWORK_HOME}/organizations/ordererOrganizations/example.com/orderers/raft2.example.com/tls/ca.crt
