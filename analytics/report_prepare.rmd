...
- Izgradnja i evaluacija modela mašinskog učenja za klasifikaciju statusa narudžbi (logistička regresija, random forest, XGBoost).
...
- `sparkxgb` – XGBoost unutar Spark okruženja
- `xgboost` – lokalna implementacija XGBoost algoritma
