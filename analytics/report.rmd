...
Posebnu pažnju zaslužuju karakteristike vezane za istoriju korisnika (`user_cancelled_count`, `user_avg_cost`) jer intuitivno nose visoku prediktivnu snagu – korisnici s većim brojem prethodnih otkazivanja vjerovatnije će otkazati i buduće narudžbine.
...
4. Segmentacija korisnika centroidnog (K-Means).
