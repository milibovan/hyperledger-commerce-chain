...
with DAG(
    dag_id='average_purchase',
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    tags=['flink', 'citus', 'hdfs', '04']
) as dag:
    ...
    create_table = SQLExecuteQueryOperator(
        ...
        conn_id='citus',
        sql="""
            CREATE TABLE IF NOT EXISTS avg_purchase (
                month VARCHAR(7) PRIMARY KEY,
                avg_orders_created DOUBLE PRECISION,
                avg_receipts_per_order DOUBLE PRECISION,
                avg_products_per_order DOUBLE PRECISION,
                avg_product_quantity_per_order DOUBLE PRECISION,
                avg_products_per_receipt DOUBLE PRECISION,
                avg_product_quantity_per_receipt DOUBLE PRECISION,
